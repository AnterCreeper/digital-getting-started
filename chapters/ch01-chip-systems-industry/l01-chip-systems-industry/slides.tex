...
\begin{tabular}{@{}c c@{}}
\raisebox{-0.5\height}{\includegraphics[width=1.1cm]{system.png}}  & \raisebox{-0.5\height}{\textbf{System / 系统层}} \\
                                                                    & {\small $\Uparrow$}                               \\
\raisebox{-0.5\height}{\includegraphics[width=1.1cm]{module.png}}  & \raisebox{-0.5\height}{\textbf{Module / 模块层}} \\
                                                                    & {\small $\Uparrow$}                               \\
\raisebox{-0.5\height}{\includegraphics[width=1.1cm]{gate.png}}    & \raisebox{-0.5\height}{\textbf{Gate / 逻辑门层}} \\
                                                                    & {\small $\Uparrow$}                               \\
\raisebox{-0.5\height}{\includegraphics[width=1.1cm]{circuit.png}} & \raisebox{-0.5\height}{\textbf{Circuit / 电路层}} \\
                                                                    & {\small $\Uparrow$}                               \\
\raisebox{-0.5\height}{\includegraphics[width=1.1cm]{nmos.png}}    & \raisebox{-0.5\height}{\textbf{Device / 器件层}}
\end{tabular}
...
\begin{frame}{Process-Level Integration}
\centering
\begin{columns}[T]
  ...
  \begin{itemize}
    ...
    \item 硅平面工艺让器件与互连更容易稳定复制
    \item 集成首先是一种\textbf{可制造、可复制}的工艺能力
    \item 后面的单元、IP、系统集成，都建立在这一层之上
  \end{itemize}
\end{columns}
\end{frame}

\begin{frame}{Block-Level Integration}
\begin{columns}[T]
  ...
  \begin{itemize}
    ...
    \item 而是说明：\textbf{工艺成熟后，功能单元可以被压进标准芯片}
    \item 从单片运放到今天的 ADC、PMIC、driver 芯片
    \item 集成化开始从``器件同片''走向``功能成块''
  \end{itemize}
...
\begin{frame}{IP-Level Integration}
\begin{itemize}
  \item 单元级集成稳定后，设计活动本身也开始集成化
  \item IP 复用让设计公司不必从零开发每个子系统
  \item 典型积木：CPU 核、DDR / USB / PCIe PHY、ADC、PLL、存储控制器
  \item 设计重点开始转向接口、约束、验证流程与工具链组织
\end{itemize}
...
\begin{frame}{System-Level Integration}
\centering
\begin{columns}[T]
  \column{0.48\linewidth}
  \centering
...
\vspace{0.3em}
\footnotesize
参考设计、评估板、软件库与在线工具，都是系统级集成继续向外延伸的结果。
\end{frame}
